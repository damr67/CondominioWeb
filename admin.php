...
<div class="row option-section">
  ...
  <div  class="option-item">
    <div class="card border-info mb-3 item-inside" style="max-width: 20rem;">
      <div class="card-body text-info">
        <h4 class="card-title">Cuentas usuarios</h4>
        <p class="card-text">Administra y crear nuevas cuentas para tus usuarios</p>
        <a href="admin-usuarios.php" class="button button-accent button-blue">Administrar</a> 
      </div>
    </div>
  </div>
  <div  class="option-item">
   ...
   <div  class="option-item">
    <div class="card border-danger mb-3 item-inside" style="max-width: 20rem;">
      <div class="card-body text-danger">
        ...
        <p class="card-text">Revisar reportes.Responder y Administrar reportes</p>
        <a href="usuario-reporte-administrar.php" class="button button-accent button-red">Ver</a> 
      </div>
    </div>
  </div>
 </body>
